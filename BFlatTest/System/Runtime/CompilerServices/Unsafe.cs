...
namespace System.Runtime.CompilerServices
{
	public static unsafe partial class Unsafe
	{
		...
		public static void Copy(ref byte fromAddress, ref byte toAddress, uint byteCount)
		{
			for (uint i = 0; i < byteCount; i++)
			{

				byte* ToB = (byte*)Unsafe.AsPointer(ref AddByteOffset(ref toAddress, i));
				byte FromB = AddByteOffset(ref fromAddress, i);
